...
python -m nesy_pi.aaa_main -m Freeway --device 8 --with_pi

python -m nesy_pi.aaa_main -m getout --device 4 --with_pi 
...
python -m nesy_pi.train_nudge -m getout -alg logic -env getout -r getout_pi --with_pi --device 6 -s 0
python -m nesy_pi.train_nudge -m atari -alg logic -env Freeway -r freeway_pi --with_pi --device 6 -s 0
python -m nesy_pi.train_nudge -m atari -alg logic -env Asterix -r asterix_pi --with_pi --device 4 -s 0
```