...
python -m nesy_pi.aaa_main -m getout --device 0 --with_pi --show_process
...
python -m nesy_pi.train_nudge -m getout -alg logic -env getout -r getout_pi --with_pi --device 5 -s 0
