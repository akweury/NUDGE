...
python -m nesy_pi.aaa_main -m loot --device 0 --with_pi --show_process
...
python -m nesy_pi.train_nudge -m loot -alg logic -env loot -r loot_pi --with_pi --device 0 -s 0
python -m nesy_pi.train_nudge -m threefish -alg logic -env threefish -r threefish_pi --with_pi --device 6 -s 0
