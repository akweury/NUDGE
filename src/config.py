...
print_freq = 1000  #max_ep_len * 4  # print avg reward in the interval (in num timesteps)
# print_freq = max_ep_len  # print avg reward in the interval (in num timesteps)
log_freq = 1000 # max_ep_len * 4  # log avg reward in the interval (in num timesteps)
save_model_freq = 1000 # max_ep_len * 50  # save model frequency (in num timesteps)
